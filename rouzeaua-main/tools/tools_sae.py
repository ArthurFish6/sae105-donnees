...
def lecture_fichier_evenements(chemin: str) -> typing.Optional[typing.List[str]]:
    """
    Lecture d'un fichier d'évènements.
...
def theme_module(module: str) -> str:
    ...
    """
    MODULE_THEME = {tools_constantes.THEME_RESEAU: tools_constantes.MODULES_RESEAU_BUT1 + tools_constantes.MODULES_RESEAU_BUT2,
                    tools_constantes.THEME_INFO: tools_constantes.MODULES_INFO_BUT1 + tools_constantes.MODULES_INFO_BUT2,
                    tools_constantes.THEME_TELECOM: tools_constantes.MODULES_TELECOM_BUT1 + tools_constantes.MODULES_TELECOM_BUT2,
                    tools_constantes.THEME_MATHS: tools_constantes.MODULES_MATHS_BUT1 + tools_constantes.MODULES_MATHS_BUT2,
                    tools_constantes.THEME_TRANSVERSES: tools_constantes.MODULES_TRANSVERSES_BUT1 + tools_constantes.MODULES_TRANSVERSES_BUT2
                    }
...
def get_event_by_id(events: typing.List[str], id: str) -> typing.Optional[str]:
    """
...
def get_jours_ouvres() -> typing.List[str]:
    """
...
def get_event_trie_par_date(events: typing.List[str]) -> typing.List[str]:
    """
